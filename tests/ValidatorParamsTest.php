...
use Yii;
use webivan\validateAction\tests\controllers\ParamsController;

class ValidatorParamsTest extends TestCase
{
    /**
    ...
    protected function setUp()
    {
        ...
        $this->controller = new ParamsController('params', Yii::$app);
    }
